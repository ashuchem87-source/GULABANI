  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Projects',
          tabBarIcon: ({ color }) => isIOS ? <SymbolView name="square.stack" tintColor={color} size={24} /> : <Feather name="layers" size={22} color={color} />,
        }}
      />
      <Tabs.Screen
        name="tasks"
        options={{
          title: 'To-do',
          tabBarIcon: ({ color }) => isIOS ? <SymbolView name="checklist" tintColor={color} size={24} /> : <Feather name="check-square" size={22} color={color} />,
        }}
      />
      <Tabs.Screen
        name="templates"
...
export default function TabLayout() {
  ...
  if (isLiquidGlassAvailable() && settings.theme === 'System') {
